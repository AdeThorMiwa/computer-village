    ...
    <SideContentWrapper>
      <div>
        <div>
          ...
          <span>{discount ? `₦${formatMoney(price)}` : ""}</span>
        ...
        <ul>
          {discount ? (
            <li>
              ...
              {discount}% discount available on every purchase you make at{" "}
              <b style={{ color: "#000" }}>₦{formatMoney(price)}</b> till{" "}
              <b style={{ color: "#000" }}>
                <Moment format="DD/MM/YYYY">{discountTill}</Moment>
              </b>
            </li>
          ) : (
            <li>
              <i className="fa fa-tag"></i> 0% Discount Available On All Sale
            </li>
          )}
        </ul>
        <div>
      ...
      <div className="">
        <h4>
          <i className="fa fa-info-circle"> </i> Description
        </h4>
        <p>
          {description
      ...
      <div>
        ...
        <div className="guarantee">
          ...
          <label>
            {guarantee && guarantee !== "0" ? `${guarantee} Year` : "No"}{" "}
            Guarantee
          </label>
        </div>
      </div>
      <div>
        <Link to={store ? `/stores/${store._id}` : ""}>
          View Store <i className="la la-eye"></i>
        </Link>
      </div>
    </SideContentWrapper>
  );
